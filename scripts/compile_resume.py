...
Reads the base template from resources/templates/latex/, copies it to
resources/workspace/, compiles with pdflatex, and saves the PDF to
resources/output/.
...
LATEX_TEMPLATE = RESOURCES_DIR / "templates" / "latex" / "GopalKumar_Resume.tex"
RUNNING_TEMPLATE = RESOURCES_DIR / "workspace" / "GopalKumar_Resume.tex"
...
def compile_resume(output_name: str | None = None, open_pdf: bool = False) -> Path:
    """Copy template, compile, and save PDF to resources/output/."""
