...
==========================================
Takes a job description, uses DeepSeek V4 Pro (via OpenCode Zen Go) to rewrite
...
def compile_latex(tex_path: Path, company: str, role: str) -> Path | None:
    ...
    # Copy to Output/ with a clean filename
...
def main():
    parser = argparse.ArgumentParser(
        description=(
            "Tailor your LaTeX resume with DeepSeek V4 Pro for ATS optimization.\n\n"
